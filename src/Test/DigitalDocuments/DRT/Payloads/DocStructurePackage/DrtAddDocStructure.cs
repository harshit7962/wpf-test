...
namespace DrtPrinting
{
    internal class DrtAddDocStructure : DrtBase
    {
        ...
        protected override void PrintOptions()
        {
            ...
            //  Examples:
            //  drtAddDocStructure /IN  DrtFiles\Payloads\Sequence\MSFTQ3-04Xls.xps /Add DrtFiles\Payloads\Sequence\MSFTQ3-04balancesheets_page_1.dsxaml /Page 0
        }
    ...
    public sealed class DrtAddDocStructureSuite : DrtTestSuite 
    {
        ...
        {
            TeamContact = "D2core";     // if different from DRT
            Contact = "mingliu";         // if different from DRT
        }
